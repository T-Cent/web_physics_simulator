# Web based physics simulator

Hello! For our DIS course in IIIT-D we decided to create an online, free to use tool that can help children interact with physics in hopes to develop their understanding of common natural phenomena and gain an intuitive feel of the same.

As of right now we've implemented the following features/topics:
...
Built by Taraash, Krishna and Divjot.
